...
let famous_person = "Prophet Muhammad (P.B.U.H)";
let message = "The merciful will be shown mercy by the Most Mercifulﷻ. Be merciful to those on the earth, and the One in the heavens will have mercy upon you.";
...
var fav_transport = ['Bicycle', 'Car', 'Aeroplane']; // array of strings
...
var dinner_invite = ["Abu Hurairah", "Naveed Sarwar", "Daniyal Nagori", "Mubashir Ali", "Zia Ullah Khan"];
console.log("\nGUEST LIST:");
// (using for of Loop)
...
var favorite_fruits = ['banana', 'cherry', 'pineapple'];
...
var userName = ["admin", "aroona89", "naveed_sarwar", "user123", "stu_4"];
...
var current_users = ['john', 'akbar', 'aroona', 'amina', 'BILAL'];
/* • Make another list of five usernames called new_users.
Make sure one or two of the new usernames are also in the current_users list. */
var new_users = ['aroona', 'JOHN', 'umer', 'fatima', 'bilal'];
...
let pizzaTypes = ["chicken tandoori", "chicken tikka", "Fajita"];
...
let magicianNames = ["abc", "xyz", "unknown"];
...
function make_great(magicians) {
    let greatMagicianNames = []; // Create a new empty array
    for (const magician of magicians) {
