...
let newAray1: string[] = ["aroona", "ali", "bilal"]; // array of strings
let newArray2: number[] = [21, 48392, 74091283, 817234, 89742, 5849]; // arrays of numbers
// tuple
let tuple: [string, number] = ["Abu Hurairah", 21];
...
function myFunction(a: string, b: string, ...rest: string[]) {
