...
fundamental control flow structures that allow your program to make decisions and execute code 
...
var section: string = 'D'; // section is key, get value from user
switch (section) {
    case 'A':
