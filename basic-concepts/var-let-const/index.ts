...
function printConsole() {
  ...
  var localVariable: number = num1 + num3 + num3; // 10 + 20 + 30
  let localVariable1: number = num1 + num3 + num3; // 10 + 20 + 30
  const localVariable2: number = num1 + num3 + num3; // 10 + 20 + 30
...
var result: number = printConsole();
console.log(result);
// console.log("result:", localVariable, localVariable1, localVariable2);
...
{
  var ifVariable: number = 8;
  let ifVariable2: number = 8;
  const ifVariable3: number = 8;
}
...
// when string appeared, after it everything will be considered as string
