...
let areaCircle: number = pie * radius ** 2; // BODMAS RULE /,* and +,- are of equal precedence
...
let sides: number = 12;
let areaCube: number = 6 * sides ** 2; // BODMAS RULE /,* and +,- are of equal precedence
...
let fahrenheitTemperature: number = 32;
