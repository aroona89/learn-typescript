...
console.log(
  chalk.bold.yellowBright("Welcome to Simple Currency Converter App!\n")
);
  ...
  switch (select.option) {
    case "Yes":
      ...
      let calculateConversion =
        (answer.inputAmount * targetCurrencyExchangeRate) /
    ...
    default:
      console.log(
        chalk.yellowBright("Thank you for using Currency Converter App!")
      );
      condition = false;
      break;
  }
